...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li><a href="<?php echo U('Categroy/index');?>" target="right"><span class="icon-caret-right"></span>分类管理</a></li>
  ...
  <h2><a href="<?php echo U('Admin/index');?>" target="right"><span class="icon-pencil-square-o" ></span>权限</a></h2>
  <ul>
