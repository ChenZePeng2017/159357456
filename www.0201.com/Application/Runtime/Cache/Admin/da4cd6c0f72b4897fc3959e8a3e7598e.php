...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo U('Index/Index');?>">梦想</a>
            </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="<?php echo U('Bran/index');?>"><i class="fa fa-sitemap"></i>商品管理<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="#">分类管理</a>
                            </li>
                            <li>
                                <a href="<?php echo U('Bran/index');?>">品牌管理</a>
                            </li>
							<li>
                                <a href="#">规格管理</a>
                            </li>
					...
					<li>
                        <a href="#"><i class="fa fa-sitemap"></i>栏目管理<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="#">分类管理</a>
                            </li>
    ...
    <!-- Morris Chart Js -->
    <script src="/Public/Admin/js/morris/raphael-2.1.0.min.js"></script>
    <script src="/Public/Admin/js/morris/morris.js"></script>
    <!-- Custom Js -->
